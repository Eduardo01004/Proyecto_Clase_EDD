...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_username.setForeground(new java.awt.Color(228, 240, 254));
        ...
        txt_password.setForeground(new java.awt.Color(228, 240, 254));

        btn_login.setBackground(new java.awt.Color(75, 119, 190));
        ...
        jButton2.setBackground(new java.awt.Color(51, 110, 123));
        ...
        jLabel2.setText("Tienda el \"ChinoShop\"");
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
       ...
       contra = txt_password.getText();
       Loguear(name, Metodos.Metodos_Funciones.sha256(contra));
        
    }//GEN-LAST:event_btn_loginActionPerformed
    
    public void Loguear(String name, String pass){
        if (name.isEmpty() || pass.isEmpty()){
            JOptionPane.showMessageDialog(null, "Algun Campo esta vacio");
        }
        else{
            Nodo_Simple aux = lista.users.Loguin(name,pass);
            if(aux != null){
